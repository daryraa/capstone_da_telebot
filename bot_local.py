...
def send_welcome(message):
    ...
    with open('template_text/welcome.txt', mode='r', encoding='utf-8') as f:
        ...
        welcome = temp.substitute(FULL_NAME = "DARY RAMADHAN ABDUSSALAM")
...
def send_about(message):
    ...
    with open('template_text/about.txt', mode='r', encoding='utf-8') as f:
        ...
        about = temp.substitute(
            STUDENT_NAME = "DARY RAMADHAN ABDUSSALAM",
            BATCH_ACADEMY = "SPARTA",
            GITHUB_REPO_LINK= "https://github.com/daryraa/capstone_da_telebot"
        )
...
kolom_str = ['ad_id']
kolom_category =  ['age','gender']
df[kolom_str]=df[kolom_str].astype(str)
df[kolom_category]=df[kolom_category].astype('category')
# check data dtypes
df.dtypes
...
def send_plot(message):
    ...
    if selected_campaign_id in unique_campaign:
        ...
        axes[2].set_ylabel("Averaged CPC", fontsize=8)
...
def echo_all(message):
    ...
    with open('template_text/default.txt', mode='r', encoding='utf-8') as f:
        ...
        default = temp.substitute(EMOJI = emoji.emojize(":face_with_hand_over_mouth:"))
